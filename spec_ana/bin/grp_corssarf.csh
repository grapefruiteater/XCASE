...
echo $regionname
if (-f ${mos1prefix}-obj-${regionname}-grp_cross.pi) then
rm ${mos1prefix}-obj-${regionname}-grp_cross.pi
endif
grppha ${mos1prefix}-obj-${regionname}.pi ${mos1prefix}-obj-${regionname}-grp_cross.pi <<EOF
chkey BACKFILE ${mos1prefix}-back-${regionname}.pi 
chkey RESPFILE ${mos1prefix}-${regionname}.rmf 
chkey ANCRFILE ${mos1prefix}-${regionname}-${regionname}.arf 
group min ${grpbin}
show group
exit
EOF
...
set regionname = $inner-$outer
echo $regionname
if ( -f ${mos2prefix}-obj-${regionname}-grp_cross.pi ) then
rm ${mos2prefix}-obj-${regionname}-grp_cross.pi
endif
grppha ${mos2prefix}-obj-${regionname}.pi ${mos2prefix}-obj-${regionname}-grp_cross.pi <<EOF
chkey BACKFILE ${mos2prefix}-back-${regionname}.pi 
chkey RESPFILE ${mos2prefix}-${regionname}.rmf 
chkey ANCRFILE ${mos2prefix}-${regionname}-${regionname}.arf 
group min ${grpbin}
exit
EOF
end
...
set regionname = $inner-$outer
echo $regionname
if( -f ${pnprefix}-obj-os-${regionname}-grp_cross.pi ) then
rm ${pnprefix}-obj-os-${regionname}-grp_cross.pi
endif
grppha ${pnprefix}-obj-${regionname}.pi ${pnprefix}-obj-os-${regionname}-grp_cross.pi <<EOF
chkey BACKFILE ${pnprefix}-back-${regionname}.pi 
chkey RESPFILE ${pnprefix}-${regionname}.rmf 
chkey ANCRFILE ${pnprefix}-${regionname}-${regionname}.arf 
group min ${grpbin}
exit
EOF
end
...
if (! -f ${prefix}-${regionname}-${regionname}.arf) then
echo ${prefix}-${regionname}-${regionname}.arf  >> $errlog
endif
