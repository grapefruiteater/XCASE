...
double Chisq::operator()(const std::vector<double>& para) const {
  ...
  Tew Tew(para[0], Tmin_fixed, factor_rcool_fixed, para[1], acool_fixed, aT_fixed, bT_fixed, para[2],n2spline);
  ...
  //-----------------------------------------------------------------------
   ...
   //       
    ...
    for(ibin=0;ibin<Nbin2;ibin++){
      ...
      // dTewmodel1_p[ibin]=pow(Tew_p(rmodel[ibin])-Tewmodel[ibin],2);
      //dTewmodel1_m[ibin]=pow(Tew_m(rmodel[ibin])-Tewmodel[ibin],2);
      dTewmodel2[ibin]=0.;
      dTewmodel[ibin]=0.;
    }
   ...
   for(iline=0;iline<Nline;iline++){  
    ...
    Tew Tew_tmp(T0_tmp,Tmin_fixed,factor_rcool_fixed,rt_tmp,acool_fixed,aT_fixed,bT_fixed,cT_tmp,n2spline);
    ...
    for(ibin=1;ibin<Nbin2;ibin++){     //ibin=0 --> rmodel=0
      ...
      //     dTewmodel[ibin]=dTewmodel1[ibin]; 
      //   dTewmodel[ibin]=sqrt(dTewmodel2[ibin]/(Nboot-1.));  
     ...
     fprintf(fp_output,"%.8e %.8e %.8e %.8e %.8e\n",rmodel[ibin],rmodel[ibin]*amtoMpc,Tewmodel[ibin],Tewmodel[ibin]-dTewmodel[ibin],Tewmodel[ibin]+dTewmodel[ibin]);
      //fprintf(fp_output,"%.8e %.8e %.8e %.8e %.8e\n",rmodel[ibin],rmodel[ibin]*amtoMpc,Tewmodel[ibin],Tewmodel[ibin]-dTewmodel1_m[ibin],Tewmodel[ibin]+dTewmodel1_p[ibin]);
      }
