...
double Chisq::operator()(const std::vector<double>& para) const {
  ...
  Tew Tew(para[0], Tmin_fixed, factor_rcool_fixed, para[1], acool_fixed, aT_fixed, bT_fixed, cT_fixed,n2spline);
...
int main(int argc, char *argv[])
{
  ...
  //-----------------------------------------------------------------------
   ...
   for(iline=0;iline<Nline;iline++){  
    ...
    Tew Tew_tmp(T0_tmp,Tmin_fixed,factor_rcool_fixed,rt_tmp,acool_fixed,aT_fixed,bT_fixed,cT_fixed,n2spline);
